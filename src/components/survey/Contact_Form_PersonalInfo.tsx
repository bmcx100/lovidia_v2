...
import { SurveyFormSchema } from "@/constants/surveyData";
...
type ContactFormProps = {
  ...
  handleNext: () => void;
  handlePrev: () => void;
  controlForm: UseFormReturn<z.infer<typeof SurveyFormSchema>>;
};

const Contact_Form_PersonalInfo = ({
  currentPage,
  totalPages,
  handleNext,
  handlePrev,
  ...
  const thisHandleSubmit = (values: z.infer<typeof SurveyFormSchema>) => {
    console.log("clicked");
    console.log({ values });
  };
    ...
    <Card>
      <CardHeader className="m-0 overflow-clip bg-brandSecondary  px-4 py-4">
        <div className="flex flex-row items-start justify-between">
          <CardTitle className="m-0 text-xl font-medium">Personal Details</CardTitle>
        </div>
