  ...
  return (
    <DrawerPortal>
      ...
      >
        {(!direction || direction === "bottom") && (
          <div>
            <div className="mx-auto mt-4 h-2 w-[100px] rounded-full bg-brandSecondary/60" />
            {children}
          </div>
        )}
        {direction === "top" && (
          <div>
            {children}
            <div className="mx-auto mb-4 h-2 w-[100px] rounded-full bg-brandSecondary/60" />
          </div>
        )}
        {direction === "right" && (
          <div className="h-screen flex justify-start items-start">
            <div className="self-center my-auto ml-4 w-2 h-[100px] rounded-full bg-brandSecondary/60" />
            {children}
          </div>
        )}
        {direction === "left" && (
          <div className="h-screen flex justify-end items-start">
            {children}
            <div className="self-center my-auto mr-4 w-2 h-[100px] rounded-full bg-brandSecondary/60" />
          </div>
        )}
      </DrawerPrimitive.Content>
    </DrawerPortal>
