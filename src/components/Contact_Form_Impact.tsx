          ...
          >
            <FormField
              ...
              render={({ field }) => {
                return (
                  <FormItem>
                    <FormLabel className="capitalize">How have you been affected?</FormLabel>
                    <FormControl>
                      <Textarea
                        {...field}
                        placeholder="How has Long COVID affected your daily activities in your work and/or personal life?"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => {
                return (
                  <FormItem>
                    <FormLabel className="capitalize">What challenges have you faced?</FormLabel>
                    <FormControl>
                      <Textarea {...field} placeholder="What challenges have you faced in managing your Long COVID?" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                );
