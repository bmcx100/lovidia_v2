...
export const RecipesData: RecipeType[] = [
  ...
  },
  {
    ...
    serves: 4,
    category: "Dinner",
    imageFilename: "spaghetti_and_meatballs.png",
  ...
  },
  {
    ...
    serves: 4,
    category: "Dinner",
    imageFilename: "rack_of_pork_ribs.png",
    title: "Rack of Pork Ribs",
    description:
      "Indulge in the rich flavors of our Oven-Roasted Pork Ribs, a mouthwatering dish that combines the classic tenderness of slow-cooked ribs with a bold dry rub blend. Seasoned with salt, pepper, garlic, onion, chili powder, and rosemary, these ribs are roasted to perfection at 350°F for two hours. The result is a succulent, fall-off-the-bone experience perfect for a family dinner or a festive gathering the highlight of any meal.",
    ingredients: [
      "1 rack of pork ribs",
    ...
    directions: [
      ...
      "Prepare the ribs by removing the membrane from the back of the rack to allow the seasoning to better penetrate the meat.",
      "Make the spice rub by combining the salt, pepper, garlic powder, onion powder, chili powder, and rosemary in a bowl.",
      "Season the ribs generously with the spice rub, ensuring both sides are well-coated.",
      "Place the ribs on a roasting pan, bone side down, and cover loosely with aluminum foil.",
      "Roast the ribs in the preheated oven for about 2 hours, or until the meat is tender and the internal temperature reaches 145°F (63°C).",
      "Optional basting: If you like, you can baste the ribs with olive oil and the rib juices",
      "Rest the ribs for 10 minutes after taking them out of the oven. This allows the juices to redistribute throughout the meat.",
    ],
  },
];
